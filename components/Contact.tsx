      ...
      <div className="mt-20 grid lg:grid-cols-2 gap-20">
        <div className="left flex flex-col justify-center items-center gap-10">
          ...
          <div className="text-xl md:text-2xl">
            ...
            >
              <ButtonAsLink href="https://www.linkedin.com/in/gulista-marium-7209b9235/" placeholder="LinkedIn" target="_blank" />
              <ButtonAsLink href="https://github.com/Maliha20" placeholder="GitHub" target="_blank" />
            </motion.div>
          </div>
          <div className="flex gap-10 flex-wrap md:flex-nowrap text-xl md:text-2xl">
            <div>
              ...
              >
                <ButtonAsLink
                  href="mailto:gulista.marium20@gmail.com"
                  placeholder="gulista.marium20@gmail.com"
                  target="_blank"
                />
              </motion.div>
            </div>
          ...
          <div className="overflow-hidden w-full">
            ...
            >
              <textarea
                ...
                name="message"
                placeholder="Message"
                className="w-full outline-none border-b bg-transparent border-light/50 pb-2 focus:border-accent duration-500 resize-none"
              />
            </motion.div>
          </div>
